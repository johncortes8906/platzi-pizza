...
TRUNCATE `platzi_pizza`.`orders_by_item`;
TRUNCATE `platzi_pizza`.`orders`;
TRUNCATE `platzi_pizza`.`customers`;
TRUNCATE `platzi_pizza`.`pizzas`;
SET FOREIGN_KEY_CHECKS = 1;

-- INSERT CUSTOMERS
INSERT INTO `platzi_pizza`.`customers` (`customer_id`, `name`, `address`, `email`, `phone_number`)
VALUES
...
-- INSERT PIZZAS
INSERT INTO `platzi_pizza`.`pizzas` (`pizza_id`, `name`, `description`, `price`, `vegetarian`, `vegan`, `available`)
VALUES
...
-- INSERT ORDERS
INSERT INTO `platzi_pizza`.`orders` (`order_id`, `customer_id`, `date`, `total`, `method`, `additional_notes`)
VALUES
...
-- INSERT ORDER ITEMS
INSERT INTO `platzi_pizza`.`orders_by_item` (`order_id`, `item_id`, `pizza_id`, `quantity`, `price`)
VALUES
    (1, 1, 1, 1, 23.0),
    (1, 2, 4, 1, 19.95),
    (2, 1, 2, 1, 18.5),
